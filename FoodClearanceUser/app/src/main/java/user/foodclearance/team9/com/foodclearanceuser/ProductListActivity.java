...
public class ProductListActivity extends AppCompatActivity {
    ...
    static final String APP_SERVER_URL_SUBSCRIBE = "http://project9.comxa.com/php/db_insert_subscribe.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.product_list_content);

        SharedPreferences pref=getSharedPreferences("data", 0);
        final String cusername=pref.getString("username","");
         Intent i = getIntent();
         final String username = i.getStringExtra("sUsername");
       ...
       // setSupportActionBar(toolbar);
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ProductListActivity.this, StoreDescriptionActivity.class);
        ...
        Button subscribe = (Button) findViewById(R.id.subscribed);
        subscribe.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                prgDialog.show();
                try {
                    jsonParams.put("sUsername", username);
                    jsonParams.put("username", cusername);
                } catch (Exception e) {
                    Log.d("Error", e.getMessage());
                }
                AsyncHttpClient client = new AsyncHttpClient();
                ...
                client.post(applicationContext, APP_SERVER_URL_SUBSCRIBE, entity, "application/json",
                        new JsonHttpResponseHandler() {
